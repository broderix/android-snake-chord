...
public class ChordSnakeService extends Service {
    public static String CHORD_APITEST_CHANNEL = "com.samsung.chord.samples.apidemo.SNAKECHANNEL";
    ...
    private String mPrivateChannelName = "snake";
    ...
    public class ChordServiceBinder extends Binder {
        public ChordSnakeService getService() {
            return ChordSnakeService.this;
        }
    }
